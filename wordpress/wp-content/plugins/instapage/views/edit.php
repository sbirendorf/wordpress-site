<h2 class="ui-subtitle" data-bind="text: id() ? '<?php echo Connector::lang('Edit page'); ?>' : '<?php echo Connector::lang('Add page'); ?>' "></h2>
<form class="c-section l-space-tertiary" data-bind="visible: subAccounts().length">
  <div class="ui-sub-section">
    <div class="l-grid l-space-top-primary">
      <div class="l-grid__cell l-grid__cell--1/3">
        <label><?php echo Connector::lang( 'Sub-account' ); ?></label>
      ...
      <div class="l-grid__cell l-grid__cell--1/3">
        <label><?php echo Connector::lang( 'Landing Page' ); ?></label>
      ...
      <div class="l-grid__cell l-grid__cell--1/3" data-bind="css: {'has-danger': !isTypeValid()}">
        <label><?php echo Connector::lang( 'Page Type' ); ?></label>
  ...
  <div class="ui-sub-section" style="margin-top: 20px;">
    <button class="fx-ripple-effect c-button c-button--regular c-button--action" data-bind="click: publishPage" type="button" ><?php echo Connector::lang( 'Publish' ); ?></button>
    <button class="fx-ripple-effect c-button c-button--regular" data-bind="click: masterModel.toolbarModel.loadListPages"><span class="c-button__text"><?php echo Connector::lang( 'Back' ); ?></span></button>
  </div>
</form>